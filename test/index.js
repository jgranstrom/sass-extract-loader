...
describe('sass-vars-loader', () => {
  it('should succesfully compile basic variables', () => {
    ...
    .then((results) => {
      ...
      expect(stats.compilation.fileDependencies).to.have.keys([source]);
    });
  });
  ...
  it('should succesfully compile nested variables', () => {
    ...
    .then((results) => {
      ...
      expect(stats.compilation.fileDependencies).to.have.keys([sourceRoot, sourceSub1, sourceSub2]);
    });
  });
  ...
  it('should succesfully track dependencies on error', () => {
    ...
    .catch(err => {
      ...
      expect(err.stats.compilation.fileDependencies).to.have.keys([source]);
    });
  });
  ...
  it('should succesfully track included dependencies on nested error', () => {
    ...
    .catch(err => {
      ...
      expect(err.stats.compilation.fileDependencies).to.have.keys([sourceRoot, sourceSub]);
    });
  });
